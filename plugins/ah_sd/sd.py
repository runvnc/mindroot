...
async def sdxl_text_to_image(prompt, negative_prompt='', model_id=None, from_huggingface=True,
...
async def sd_text_to_image(prompt, negative_prompt='', model_id=None, from_huggingface=True, count=1,
