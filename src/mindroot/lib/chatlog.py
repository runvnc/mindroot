...
class ChatLog:
    ...
    def _fire_message_added_hook(self, message: Dict[str, str]) -> None:
        """Fire the message_added hook in a background task (non-blocking).
        
        This is used to notify other systems (like job queue workers) that a
