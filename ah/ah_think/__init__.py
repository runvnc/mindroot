...
async def think(thoughts="", context=None):
    ...
    thoughts (str): The extensive thought process to consider before issuing additional commands.
    ...
    5. follow a reasoning chain
    6. evaluate your final solution in reference to the original task
    7. make any improvements you can think of
    8. show your work as you go
    9. CRITICAL -- repeat all of the steps until you are truly certain you have refined as much as possible!!
